...
public class ElectronicsController {
    ...
    @RequestMapping(value = "/selection/{brand}/{color}/{price}/{categoryItem}", method = RequestMethod.GET)
    public
    @ResponseBody
    String getAllSelect(@PathVariable("brand") String brand, @PathVariable("color") String color, @PathVariable("price") String price,
        ...
        try {
            List<PElectronics> finalProd = dataServices.getAllElectronicsList(brand, color, maxPrice, minPrice, categoryItem);
            Gson gson = new Gson();

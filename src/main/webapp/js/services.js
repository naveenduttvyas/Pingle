...
services.factory('WomenFactory', ['$resource', '$rootScope', '$cacheFactory', function ($resource, $rootScope, $cacheFactory) {
    ...
    return  {
        ...
        selectionclothing: $resource('/women/selectionclothing/:brand/:color/:price/:categoryItem', {}, {
            query: {method: 'GET', isArray: true, params: {brand: '@brand', color: '@color', price: '@price', categoryItem: '@categoryItem'}, cache: true },
            create: {method: 'POST'}
        }),
...
services.factory('ElectronicsFactory', ['$resource', '$rootScope', '$cacheFactory', function ($resource, $rootScope, $cacheFactory) {
    ...
    return  {
        ...
        selectionclothing: $resource('/elect/selectionclothing/:brand/:color/:price/:categoryItem', {}, {
            query: {method: 'GET', isArray: true, params: {brand: '@brand', color: '@color', price: '@price', categoryItem: '@categoryItem'}, cache: true },
            create: {method: 'POST'}
        }),

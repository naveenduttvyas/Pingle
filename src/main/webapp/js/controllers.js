...
app.controller('ElectronicsCtrl', ['$scope', '$rootScope', '$location', 'ElectronicsFactory',
    function ($scope, $rootScope, $location, ElectronicsFactory) {
        ...
        $rootScope.resultForSelection = function (brand, color, price, categoryItem) {
            ...
            $rootScope.electronicsList = ElectronicsFactory.selectionclothing.query({brand: brand, color: color, price: price, categoryItem: categoryItem});
        };
...
app.controller('WomenCtrl', ['$scope', '$rootScope', '$location', 'WomenFactory',
    function ($scope, $rootScope, $location, WomenFactory) {
        ...
        $rootScope.resultForSelection = function (brand, color, price, categoryItem) {
            ...
            $rootScope.womenList = WomenFactory.selectionclothing.query({brand: brand, color: color, price: price, categoryItem: categoryItem});
        };
...
app.controller('MenCtrl', ['$scope', '$rootScope', '$location', 'MenFactory',
    function ($scope, $rootScope, $location, MenFactory) {
        ...
        /* $rootScope.brandList = MenFactory.allbrands.query({category: 'Jean'});
         $rootScope.colorList = MenFactory.allcolor.query({category: 'Jean'});
         $rootScope.priceList = [
         {
         price: "Rs. 2000 and below"
         },
